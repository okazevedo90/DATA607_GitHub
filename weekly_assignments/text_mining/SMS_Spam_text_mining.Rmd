...
Demonstrate tidying text data and performing text processing via lexicon-based sentiment analysis. The corpus used for this assignment is a collection of SMS messages tagged as spam or legitimate. The files contain one message per line. Each line is composed by two columns:
...
## Load Data
```{r}
data = read.csv('~/Documents/CUNY/Spring 2025/DATA607/DATA607_GitHub/spam.csv')
slang_ref = read.csv('~/Documents/CUNY/Spring 2025/DATA607/DATA607_GitHub/slang.csv')
```
